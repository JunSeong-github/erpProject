...
public enum ErrorCode {
    ...
    ITEM_CODE_IN_USE(409, "ST003", "이미 발주·입고에 사용된 품목은 품목코드를 변경할 수 없습니다. (품목명·단가는 수정 가능)"),
    ITEM_IN_USE(409, "ST004", "이미 발주·입고에 사용된 품목은 삭제할 수 없습니다."),

    //vendor
    VENDOR_IN_USE(409, "VD001", "발주에 사용된 공급사는 삭제할 수 없습니다."),
    VENDOR_CODE_IN_USE(409, "VD002", "발주에 사용된 공급사는 공급사코드를 변경할 수 없습니다. (공급사명은 수정 가능)"),
